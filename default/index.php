...
<div class="page">
    ...
    <div class="main">
        <section class="section">
            <div class="container">
                <div class="is-size-4 is-family-primary has-text-centered has-text-weight-bold">Free Public WiFi</div>
                <div class="content is-size-6 is-family-primary has-text-centered">Please enter your details for WiFi access</div>
                <div class="is-size-6 is-family-primary has-text-centered">For information about how The R&A</div>
                <div class="content is-size-6 is-family-primary has-text-centered">processes personal data, visit our <a href="policy.php">Privacy Policy</a></div>
